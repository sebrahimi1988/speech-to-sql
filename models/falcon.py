...
def load_model(model_name: str = "tiiuae/falcon-7b-instruct"):
    cache_path = "/dbfs/FileStore/falcon/cache"
...
class InstructionTextGenerationPipeline:
    def __init__(
        ...
        self.generate_kwargs = {
            ...
            #"repetition_penalty": 1.0 #1.1,  # 1.0 means no penalty, > 1.0 means penalty, 1.2 from CTRL paper
        }
    ...
    def process_stream(self, instruction, temperature, top_p, top_k, max_new_tokens):
        # Tokenize the input
